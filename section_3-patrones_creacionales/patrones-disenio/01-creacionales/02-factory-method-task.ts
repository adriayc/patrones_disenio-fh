 ...
 *
 * 3. Prueben el programa generando diferentes tipos de reportes usando el
 *    prompt para seleccionar el tipo de reporte.
 */
...
class InventoryReport implements Report {
  ...
  // 'Generando reporte de inventorio...'
  generate(): void {
...
// 4. Clases Concretas de Fábrica de Reportes
