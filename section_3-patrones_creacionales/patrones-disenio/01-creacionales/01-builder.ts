 ...
 * paso a paso.
 *
 * El patrón nos permite producir distintos tipos y representaciones de un objeto
 * empleando el mismo código de construcción.
 *
 * * Es útil cuando necesitamos construir un objeto complejo con muchas partes y
 * * queremos que el proceso de construcción sea independiente de las partes que
 * * lo componen
 *
