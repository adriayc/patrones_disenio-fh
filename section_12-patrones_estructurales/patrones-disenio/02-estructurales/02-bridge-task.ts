...
abstract class Notification {
  ...
  // TODO: Definir el contructor de la clase
  // TODO: Definir el método `notify` y `setChannel` (abstractos)
}

// 4. Classes Concretas de Notificaciones
...
class PushNotification extends Notification {
  ...
  override setChannel(channle: NotificationChannel): void {
    // TODO: Asignar el canal a la propiedad `channel`
    throw new Error('Method not implemented.');
  }
}
...
// TODO: Toda la función main deve de ejecutarse sin errores, sin modficicaciones
