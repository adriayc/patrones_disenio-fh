/**
 * ! Patrón Facade
 * Este patrón proporciona una interfaz unificada para un conjunto de interfaces en un subsistema.
 *
 * Facade define una interafaz de nivel más alto que hace que el subsistema sea más fácil de usar.
 *
 * * Es útil cuando un subsistema es complejo o difícil de entender para proporcionar una interfaz
 * * simplificada para el cliente.
 *
...
// ! Tarea: Sistema de Encendido de una Computadora con el Patrón Facade
...
class CPU {
  ...
  jump(position: number): void {
    console.log(`CPU: Saltando a la posición de memória ${position}.`);
  }
...
class ComputerFacade {
  ...
  startComputer(): void {
    ...
    // 1. Cargar el sistema operativo en la memoria - memory.load(0, hardDriver.read(0, 1014))
  ...
  shutDownComputer(): void {
    ...
    console.log('Cerrando procesos y guardado datos...');

    // TODO: ejecutar las operaciones necesarias para apagar la computadora
    // 1. Detener las operaciones del CPU - cpu.stopOperation()
