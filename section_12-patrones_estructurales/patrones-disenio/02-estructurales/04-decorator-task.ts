/**
 * ! Patrón decorador
 * Es un patrón de diseño estructural que permite añadir funcionalidades a objetos, colocando estos
 * objetos dentro de objetos encapsuladores especiales que contienen estas funcionalidades.
 *
 * No confundirlo con los decoradores de TypeScript que son anotaciones.
 *
 * * Es útil cuando necesitas añadir funcionalidades a objetos de manera dinámica y flexible.
 *
...
abstract class CharacterDecorator implements Character {
  ...
  // TODO: Implementar los métodos de la interfaz Character, pero retornando la descripción y estadísticas del personaje decorado
  getDescription(): string {
