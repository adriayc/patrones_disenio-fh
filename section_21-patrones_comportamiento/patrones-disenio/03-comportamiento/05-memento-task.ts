...
class DrawingMemento {
  ...
  constructor(shapes: string[]) {
    ...
    this.shapes = [...shapes]; // Copiar la referencia
  }

  getShapes(): string[] {
    return [...this.shapes]; // Devolver la referencia
  }
}
...
class DrawingBoard {
  ...
  restore(memento: DrawingMemento): void {
    ...
    console.log(`\n%cEstado de la pizarra restaurado.`, COLORS.blue);
  }
}
...
class History {
  ...
  // Guardar un Memento
  // TODO: Implementar push para guardar en el historia
