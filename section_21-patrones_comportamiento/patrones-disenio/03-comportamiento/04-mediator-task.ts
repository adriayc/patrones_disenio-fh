 ...
 *     La torre de control coordina las comunicaciones entre los aviones para evitar colisiones y
 *     recibir sus solicitudes de despegue o aterrizaje.
 *
 * 2. Clase Airplane:
 *   • Representa a un avión que puede enviar y recibir mensajes a través de la torre de control.
 *     Los aviones no se comunican directamente entre sí, sino a través de la torre de control,
 *     que gestiona la información.
 *
 * 3. Interacciones:
 *   • Los aviones pueden solicitar permiso para aterrizar o despegar, y la torre de control
 *     enviará mensajes a los demás aviones notificándolos de la actividad de cada avión.
 */
...
// ! Aqui no hay nada que modificar en este bloque
function main() {
