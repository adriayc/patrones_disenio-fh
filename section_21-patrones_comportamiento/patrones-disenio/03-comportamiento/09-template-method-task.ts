 ...
 *
 * El patrón Template Method es un patrón de diseño de comportamiento que define el esqueleto de
 * un algoritmo en una operación, delegando algunos pasos a las subclases.
 *
 * Permite que las subclases redefinan ciertos pasos de un algoritmo sin cambiar su estructura.
 *
 * * Es útil cuando se tiene un algoritmo que sigue una secuencia de pasos y se quiere permitir
 * * a las subclases que redefinan algunos de esos pasos.
 *
...
/**
 * Objetivo: Implementar el patrón Template Method para simular un sistema de limpieza de diferentes
 * tipos de habitiaciones (por ejemplo, una habitación de hotel y una sala de conferencias).
 *
 * Debes diseñar una clase base que defina el flujo general de limpieza y subclases que implementen
 * pasos especificos dependiendo del tipo de habitación.
 */

/**
 * ! Descripción del Ejercició
 ...
 *  3. Limpieza especifica: Depende del tipo de habitación:
 *   - En una habitación de hotel, se hacen las camas.
 *   - En uan sala de conferencias, se limpian las mesas y se organizan las sillas.
...
abstract class RoomCleaning {
  ...
  // Método abstracto para limpieza especifica
  protected abstract specificCleaning(): void;
}

// Subclase - HotelRoomCleaning
class HotelRoomCleaning extends RoomCleaning {
  // Mensaje: 'Haciendo las camas y reponiendo articulos de baño'
  protected override specificCleaning(): void {
    console.log('Haciendo las camas y reponiendo articulos de baño');
  }
}
...
// Código Cliente
function main(): void {
  console.log('%cLimpieza de una habitación del hotel:', COLORS.blue);
