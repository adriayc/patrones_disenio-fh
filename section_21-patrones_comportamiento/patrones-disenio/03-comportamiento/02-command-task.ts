...
class PasteCommand implements Command {
  ...
  // TODO: Inyectar el editor en el constructor y el método execute con la accíon respectiva
}
...
class Toolbar {
  ...
  clickButton(button: string): void {
    ...
    console.log(`No hay un comando asignado al botón "${button}"`);
  }
}
...
function main() {
  ...
  // Asignar comandos a los botones d ela barra de herramientas
